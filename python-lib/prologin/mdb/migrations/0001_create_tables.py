    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "network",
                    models.CharField(max_length=32, unique=True, verbose_name="CIDR"),
                ),
                (
                    "last",
                    models.IntegerField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "value_str",
                    models.CharField(
                        blank=True, max_length=64, null=True, verbose_name="String"
                    ),
                ),
                (
                    "value_int",
                    models.IntegerField(blank=True, null=True, verbose_name="Int"),
                ),
            ],
