...
champion_patterns = [
    ...
    path("<int:pk>/sources/", views.ChampionSources.as_view(), name="champion-sources"),
...
tournament_patterns = [
    ...
    path("<int:pk>/", views.TournamentView.as_view(), name="tournament-detail"),
    path(
        "<int:pk>/matches/<int:champion>/",
        views.TournamentMatchesView.as_view(),
        name="tournament-matches-view",
    ),
    path(
        "<int:pk>/correct/<int:player>/",
        views.TournamentCorrectView.as_view(),
        name="tournament-correct",
    ),
    path(
        "<int:pk>/correct/<int:player>/delete",
...
urlpatterns = [
    path("", (TemplateView.as_view(template_name="stechec/home.html")), name="home"),
    path(
        "login/",
    ...
    path("ask-help/list/", views.AskForHelpList.as_view(), name="ask-for-help-list"),
    path("report-bug/", views.ReportBug.as_view(), name="report-bug"),
    path("report-bug/list/", views.ReportBugList.as_view(), name="report-bug-list"),
