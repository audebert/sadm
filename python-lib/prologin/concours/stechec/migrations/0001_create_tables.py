    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(verbose_name="nom", max_length=100, unique=True),
                ),
                (
                    "status",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "official",
                    models.BooleanField(verbose_name="officielle", default=False),
                ),
                ("ts", models.DateTimeField(verbose_name="date", auto_now_add=True)),
                (
                    "author",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "options",
                    models.CharField(
                        verbose_name="options", max_length=500, default="{}"
                    ),
                ),
                (
                    "file_options",
                    models.CharField(
                        verbose_name="file_options", max_length=500, default="{}"
                    ),
                ),
                (
                    "author",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "map",
                    models.ForeignKey(
                        verbose_name="carte", to="stechec.Map", on_delete=models.CASCADE
                    ),
                ),
                (
                    "tournament",
