...
async def fortunes(s):
    l = [
        ...
        " Les plaisirs délicieux de l'innocence ne sont une chimère que pour les violents. ",
        ...
        " L'étude étend peu les connaissances, si elle n'ôte pas la sottise. ",
        " Qui brûle un tableau pour en avoir les cendres sacrifie sa conscience à son ambition. ",
        " Qui ne sait pas se vanter ignore l'art de parvenir. ",
    ...
    while True:
        if i % 2 == 0:
            ...
            motd = (
                f"Aucune pression, il reste {remain:.0f} heures avant le dernier rendu…"
            )
        i += 1
